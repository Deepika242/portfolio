    ...
    <div className="flex items-center justify-center">
      <ResponsiveDialog>
        <ResponsiveDialogTrigger className="bg-transparent flex justify-center w-full">
          <div
            className="group relative w-full max-w-[430px] h-auto rounded-2xl overflow-hidden ring-1 ring-white/10 shadow-lg transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl"
          ...
          >
            ...
            />
            <div className="absolute w-full h-32 bottom-0 left-0 bg-gradient-to-t from-background via-background/95 to-transparent pointer-events-none z-10">
